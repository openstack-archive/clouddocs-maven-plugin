  ...
  extends com.agilejava.docbkx.maven.AbstractEpubMojo
{
  ...
  protected void transformCover() throws MojoExecutionException {
   ...
   protected void copyTemplate(File targetDirectory) throws MojoExecutionException {
        ...
        org.openstack.docs.FileUtils.extractJaredDirectory("common", EpubMojo.class, targetDirectory);
  ...
  public void preProcess() throws MojoExecutionException {
        ...
        //
        org.openstack.docs.FileUtils.extractJaredDirectory("images", PDFMojo.class, imageParentDirectory);
        setImageDirectory (new File (imageParentDirectory, "images"));

        //
        // Extract all fonts into fonts directory
        //
        org.openstack.docs.FileUtils.extractJaredDirectory("fonts", PDFMojo.class, imageParentDirectory);
    }
