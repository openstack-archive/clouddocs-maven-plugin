  ...
  <xsl:template match="d:book">
    <html lang="en">
      ...
      <body>
              ...
              <div class="container">
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand"
                    href="http://localhost:8000/">Rackspace ::
                    Develop</a>
                </div>
                <div class="collapse navbar-collapse"
                  ...
                  <ul class="nav navbar-nav navbar-right">
                    <li>
                      <a href="http://localhost:8000/sdks/">SDKs &amp;
                        Tools</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="http://localhost:8000/community/"
                        >Community</a>
                    </li>
                    <li class="dropdown">
                        ...
                        <div id="footer" class="clearfix">
                          ...
                          <div id="basement-wrap">
                            <div class="container">
                              <div class="row">
                                <div class="col-md-1">
                                  <img src="common/images/rackerpowered-logo.png" alt="Racker Powered"/>
                                </div>
        ...
        <script src="apiref/css/app-86aefccf54597dda65ee681f8853c86a.js"></script>
        
        <!-- syntax highlighter: -->
        <script src="apiref/css/highlight.js"></script>
