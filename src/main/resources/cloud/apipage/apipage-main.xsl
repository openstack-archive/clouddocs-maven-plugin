    ...
    <html lang="en">
      ...
      <body>
        <xsl:choose>
          <xsl:when test="$branding = 'rackspace'">
            <div
              class="navbar navbar-fixed-top navbar-inverse navbar-default">
                                    <div class="container">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">Rackspace ::
                  Develop</a>
              </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <ul>
                            ...
                            <li>
                              <a href="http://stories.rackspace.com"
                        ...
                        <div class="col-md-6">
                          <ul>
                            <li>
                              <a href="http://www.rackspace.com/blog/"
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-8"><span class="footerlink">
                          <a href="/about/" class="basement">About
                            Rackspace</a>
                          ...
                          <a href="/information/legal/websiteterms"
