<?xml version="1.0" encoding="utf-8"?>
        <xsl:stylesheet
          ...
          <xsl:template match="d:preface|d:chapter">
            <div id="{@xml:id}">
              <div class="subhead">
                <xsl:choose><xsl:when test="$branding = 'rackspace'"><h2-rackspace><xsl:value-of select="d:title"/>
                  <a class="headerlink" title="Permalink to this headline" href="#{@xml:id}">
                    <span class="glyphicon glyphicon-link"></span>
                  </a>
                </h2-rackspace></xsl:when>
                  <xsl:otherwise><h2><xsl:value-of select="d:title"/>
                    <a class="headerlink" title="Permalink to this headline" href="#{@xml:id}">
                      <span class="glyphicon glyphicon-link"></span>
                    </a>
                  </h2></xsl:otherwise></xsl:choose>
              </div>
          ...
          <xsl:template match="wadl:method">
            ...
            <div class="doc-entry">
              <div class="row {$id}">
                <xsl:choose><xsl:when test="$branding = 'rackspace'">
                 <!-- <link href="apiref/css/main-rackspace.css"
                    rel="stylesheet" type="text/css"/>-->
                  <div class="col-md-1">
                    <span class="label label-success-rackspace"><xsl:value-of select="@name"/></span>
                  </div>
                </xsl:when>              
                 <xsl:otherwise> 
              <!--     <link href="apiref/css/main.css"
              ...
              <div class="col-md-5">
                ...
                <xsl:choose><xsl:when test="$branding = 'rackspace'"><div class="col-md-1">
                  <button class="btn btn-info-rackspace btn-sm btn-detail" id="detail-{$id}-btn" data-toggle="collapse" data-target="#detail-{$id}">detail</button>
                </div></xsl:when><xsl:otherwise><div class="col-md-1">
