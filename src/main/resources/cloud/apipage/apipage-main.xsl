          ...
          <xsl:when test="$branding = 'rackspace'">
            <div class="header">
              <div class="inner clearfix">
                <a class="title"
                  href="http://162.242.151.184/index.html">Rackspace
                  Developer Portal</a>
                <ul>
                  <li>
                    <a href="http://162.242.151.184/main-sdks.html"
                      >SDKs</a>
                  </li>
                  <li>
                    <a
                      href="http://162.242.151.184/main-services.html"
                      >Services</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="http://162.242.151.184/blog-list.html"
                      >Developer Blog</a>
                  </li>
                  <li>
                    <a href="#">Sign Up</a>
                  ...
                  <li>
                    <form>
                      <input name="" id=""
                        placeholder="Search our docs" type="search"/>
  ...
  <xsl:template match="wadl:method">
    ...
    <div class="doc-entry">
      <div class="row {$id}">
        ...
        <!-- add short description to the summary table. -->
        <div class="col-md-5">
          <xsl:choose>
            <xsl:when
